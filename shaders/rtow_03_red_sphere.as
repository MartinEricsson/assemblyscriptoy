...
// ============================================================
//  A unit-diameter sphere sits at (0, 0, -1). Any ray whose
//  quadratic discriminant is non-negative is colored red. Hits
//  behind the camera are not yet rejected.
// ============================================================
...
function hitSphere(
  ...
  const b: f32 = -2.0 * dot3(dx, dy, dz, ocx, ocy, ocz);
...
export function main(): void {
  ...
  for (let i: i32 = 0; i < WIDTH * HEIGHT; i++) {
    ...
    if (imageY >= 0 && imageY < IMAGE_HEIGHT) {
      ...
      if (hitSphere(0.0, 0.0, 0.0, dx, dy, dz, 0.0, 0.0, -1.0, 0.5)) {
        r = 255;
        g = 0;
        b = 0;
      } else {
