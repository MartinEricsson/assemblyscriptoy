...
// ============================================================
//  Look-from camera, thin-lens defocus, dielectric / metal /
//  lambert materials, and a reduced random sphere field. One
//  path per frame accumulates in persistent memory.
// ============================================================
...
// tan(vfov/2) and tan(defocus_angle/2); avoid Mathf.tan, whose
// AssemblyScript libm lowering leaves unresolved WGSL constants.
